...
void RTC::DS1302_clock_burst_write( uint8_t *p)  {                                            //|    |
  int i;                                                                                                 //|    |
  _DS1302_start();                                                                                       //|    |
                                                                                                         //|    |
...
uint8_t RTC::DS1302_read(int address)  {                                                      //|    |
  uint8_t data;                                                                                          //|    |
                                                                                                         //|    |
...
void RTC::setDS1302Time(uint8_t seconds, uint8_t minutes, uint8_t hours, uint8_t dayofweek,   //|    |
